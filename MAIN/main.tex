...
\begin{equation}
    x_{\mathrm{scaled}} = \frac{x - \operatorname{Median}(x)}{\operatorname{IQR}(x)},
...
\subsubsection{Công thức tính $\hat{y}$ thep trọng số}
\begin{equation}
...
\vspace{0.3cm}
\textbf{Ví dụ 1 — Mẫu Train STT 6: $\mathbf{z}_6 = (0.5571,\ 0.7428,\ 0.3714)$, Nhãn 1.}
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t1} \cdot \mathbf{z}_6
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t1} \cdot \mathbf{z}_{12}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t1} \cdot \mathbf{z}_{10}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t2} \cdot \mathbf{z}_{11}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t2} \cdot \mathbf{z}_{18}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t2} \cdot \mathbf{z}_{24}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t3} \cdot \mathbf{z}_{19}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t3} \cdot \mathbf{z}_{25}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t3} \cdot \mathbf{z}_{23}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t4} \cdot \mathbf{z}_{24}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t4} \cdot \mathbf{z}_{18}
...
\begin{itemize}
    \item Tích vô hướng:
    \[
        \mathbf{z}_{t4} \cdot \mathbf{z}_{11}
